...
public class OrderController {
    ...
    public ResponseEntity<List<String>> getOrdersByPartnerId(@PathVariable String partnerId){
        ...
        orders = orderService.getAllOrdersByPartner(partnerId);
    ...
    public ResponseEntity<String> getLastDeliveryTimeByPartnerId(@PathVariable String partnerId){
        ...
        time = orderService.lastDeliveryTimeByPartner(partnerId);
    ...
    public ResponseEntity<String> deletePartnerById(@PathVariable String partnerId){
        ...
        orderService.deletePartnerAndUnassignedTheirOrder(partnerId);
    ...
    public ResponseEntity<String> deleteOrderById(@PathVariable String orderId){
        ...
        orderService.deleteOrderAndUnassignedItsPartener(orderId);
